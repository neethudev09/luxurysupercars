/**
 * The official UAE Dirham currency symbol (2025). Filled glyph supplied by the
 * design team (Dirham.svg). It inherits text colour via `fill="currentColor"`
 * and its native aspect ratio (85.41 × 74.28) is preserved by sizing on height
 * only, so it never looks squashed wherever a price is rendered.
 */
