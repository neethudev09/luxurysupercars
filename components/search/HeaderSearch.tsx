...
export default function HeaderSearch({ onResultClick }: { onResultClick?: () => void }) {
  ...
  return (
    <div ref={boxRef} className="relative z-[9999] w-full lg:w-[260px]">
      ...
      {open && query.trim() && (
        <div className="absolute left-0 top-[calc(100%+10px)] z-[9999] w-[360px] overflow-hidden rounded-2xl border border-[var(--champagne)]/35 bg-[var(--bg-obsidian)]/95 shadow-[0_24px_60px_-20px_rgba(0,0,0,0.8)] backdrop-blur-xl">
          {results.length > 0 ? (
