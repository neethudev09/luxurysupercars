  ...
  return (
    ...
    >
      <div className="container-x">
        ...
        <Reveal className="mt-10 md:mt-12 flex justify-end">
          <Link
            href={ctaHref}
            className={`group inline-flex items-center gap-2.5 rounded-full px-5 py-2.5 text-[12.5px] font-medium tracking-wide transition-all ${
              isLight
