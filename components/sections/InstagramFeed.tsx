...
const INSTAGRAM_POSTS = [
  {
    ...
    link: "https://www.instagram.com/luxurysupercarsdubai/reel/DZ9-lRPIYgU/",
    caption: "View on Instagram",
  },
  {
    image: "/images/instagram/insta2.webp",
    link: "https://www.instagram.com/luxurysupercarsdubai/p/DZ7yilmCCpB/",
    caption: "View on Instagram",
  },
  {
    image: "/images/instagram/insta3.webp",
    link: "https://www.instagram.com/luxurysupercarsdubai/reel/DZucWdhIjdV/",
    caption: "View on Instagram",
  },
  {
    image: "/images/instagram/insta4.webp",
    link: "https://www.instagram.com/luxurysupercarsdubai/reel/DZr1EeDOB_v/",
    caption: "View on Instagram",
  },
  {
    image: "/images/instagram/insta5.webp",
    link: "https://www.instagram.com/luxurysupercarsdubai/reel/DZnLseeomjn/",
    caption: "View on Instagram",
  },
];
...
function ReelIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M2 9.5h20M9 2.5l-3.5 7M16 2.5l-3.5 7" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <rect x="2" y="2.5" width="20" height="19" rx="3" stroke="currentColor" strokeWidth="1.5" />
      <path d="M10.5 12.5l4 2.5-4 2.5v-5z" fill="currentColor" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
    </svg>
  );
}
      ...
      <div className="container-x">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
          {INSTAGRAM_POSTS.map((post, i) => (
            <Reveal key={post.image} className="rise group" delay={i * 80}>
              <a
                href={post.link}
                target="_blank"
                rel="noreferrer"
